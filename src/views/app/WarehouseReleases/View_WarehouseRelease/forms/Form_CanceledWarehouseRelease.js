...
import {canceledWarehouseRelease} from "app/crud/app/warehouseReleases/canceledWarehouseRelease";
import {Pen, Tag} from "react-bootstrap-icons";
import {SIZE_INPUT_ICON} from "../../../../../app/config/sizes";


export const FormCanceledWarehouseRelease = ({
                                              closeModal = () => {
                                              }
                                            }) => {
  ...
  const mutation = useHookFormMutation(methods, canceledWarehouseRelease(warehouseReleaseId), {
    handleSuccess,
    handleError
  });
