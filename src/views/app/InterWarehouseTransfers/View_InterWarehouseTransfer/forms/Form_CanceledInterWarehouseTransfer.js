...
import {canceledInterWarehouseTransfer} from "app/crud/app/interWarehouseTransfers/canceledInterWarehouseTransfer";
import {Pen, Tag} from "react-bootstrap-icons";
import {SIZE_INPUT_ICON} from "../../../../../app/config/sizes";


export const FormCanceledInterWarehouseTransfer = ({
                                                    closeModal = () => {
                                                    }
                                                  }) => {
  ...
  const handleError = () => {
    toast.error("Potwierdzenie przesuniecia nie powiodło się.")
  }

  const mutation = useHookFormMutation(methods, canceledInterWarehouseTransfer(interWarehouseTransferId), {
    handleSuccess,
    handleError
  });
