...
import {canceledInterWarehouseReceipt} from "app/crud/app/interWarehouseReceipts/canceledInterWarehouseReceipt";
import {Pen, Tag} from "react-bootstrap-icons";
import {SIZE_INPUT_ICON} from "../../../../../app/config/sizes";


export const FormCanceledInterWarehouseReceipt = ({
                                               closeModal = () => {
                                               }
                                             }) => {
  ...
  const methods = useForm({
    defaultValues: {
      interWarehouseReceiptId: interWarehouseReceiptId
    },
  });
  ...
  const mutation = useHookFormMutation(methods, canceledInterWarehouseReceipt(interWarehouseReceiptId), {
    handleSuccess,
    handleError
  });
