...
import navigationConfig from "app/config/@vuexy/navigationConfig"
import SideMenuGroup from "@vuexy/includes/menu/vertical-menu/sidemenu/SideMenuGroup"
...
class SideMenuContent extends React.Component {
  constructor(props) {
    ...
    this.redirectUnauthorized = () => {
      this.props.history.push(route['auth.unauthorized'])
    }
  }
  state = {
    flag: true,
  ...
  render() {
    ...
    const menuItems = navigationConfig(this.props.t).map(item => {
      ...
      if (
        ...
        (item.type === "item" &&
          item.permissions &&
          item.permissions.some(permission => this.props.userRoles.includes(permission))) ||
...
export default withRouter(withTranslation('core')(SideMenuContent));
