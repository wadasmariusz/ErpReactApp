...
import {FormConfirmWarehouseRelease} from "../../forms/Form_ConfirmWarehouseRelease";


export const ConfirmWarehouseRelease = ({...props}) => {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} toggle={close} size="lg">
        ...
        <ModalBody>
          <FormConfirmWarehouseRelease closeModal={close}/>
        </ModalBody>
      </Modal>
    </>
  );
