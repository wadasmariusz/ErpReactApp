...
import {canceledInterWarehouseRelease} from "app/crud/app/interWarehouseReleases/canceledInterWarehouseRelease";
import {Pen, Tag} from "react-bootstrap-icons";
import {SIZE_INPUT_ICON} from "../../../../../app/config/sizes";


export const FormCanceledInterWarehouseRelease = ({
                                               closeModal = () => {
                                               }
                                             }) => {
  ...
  const mutation = useHookFormMutation(methods, canceledInterWarehouseRelease(interWarehouseReleaseId), {
    handleSuccess,
    handleError
  });
