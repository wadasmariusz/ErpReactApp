...
import {EditPigeonWarehouse} from "views/app/Pigeons/View_Pigeon/components/modal/EditPigeonWarehouse";

export const CardPigeonWarehouse = () => {
  ...
  return (
    <>
      {data?.warehouse?.id ? (
        ...
        <p className={"mb-50"}>Brak przypisanego gołębnika</p>
      )}
      <EditPigeonWarehouse/>
    </>
  )
