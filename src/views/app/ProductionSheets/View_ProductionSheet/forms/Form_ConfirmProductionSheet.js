...
import {confirmProductionSheet} from "app/crud/app/productionSheets/confirmProductionSheet";
import {Pen, Tag} from "react-bootstrap-icons";
import {SIZE_INPUT_ICON} from "../../../../../app/config/sizes";


export const FormConfirmProductionSheet = ({
                                              closeModal = () => {
                                              }
                                            }) => {
  ...
  const mutation = useHookFormMutation(methods, confirmProductionSheet(productionSheetId), {
    handleSuccess,
    handleError
  });
