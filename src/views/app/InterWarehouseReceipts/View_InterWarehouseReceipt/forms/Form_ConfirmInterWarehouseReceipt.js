...
import {confirmInterWarehouseReceipt} from "app/crud/app/interWarehouseReceipts/confirmInterWarehouseReceipt";
import {Pen, Tag} from "react-bootstrap-icons";
import {SIZE_INPUT_ICON} from "../../../../../app/config/sizes";


export const FormConfirmInterWarehouseReceipt = ({
                                              closeModal = () => {
                                              }
                                            }) => {
  ...
  const mutation = useHookFormMutation(methods, confirmInterWarehouseReceipt(interWarehouseReceiptId), {
    handleSuccess,
    handleError
  });
